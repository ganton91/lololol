...
// Pre-allocated working arrays for orient2d
...
// Pre-allocated working arrays for incircle
...
export function orient2dSign(ax, ay, bx, by, cx, cy) {
...
// Returns +1 (inside), -1 (outside), or 0 (on circle)
// Points a,b,c must be in CCW order
export function incircleSign(ax, ay, bx, by, cx, cy, dx, dy) {
    const adx = ax - dx, bdx = bx - dx, cdx = cx - dx;
    const ady = ay - dy, bdy = by - dy, cdy = cy - dy;
